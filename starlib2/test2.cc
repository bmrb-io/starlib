...
//    -------------------------------------
void make_loop_gone( DataLoopNode *loop_ptr );
...
int main( int argc, char **argv )
{
    ...
    // -----------------------------------------------
    os = new ofstream( fileno(stdout) );  // output
    yyin = stdin; // input
	...
	make_loop_gone( original_loop_ptr );
    ...
    delete os; // Must do this to close the output, else it never flushes
